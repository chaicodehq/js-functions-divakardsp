...
if(player === undefined || player === null || ! player.name) return null;
  ...
  const isHeAllRounder = isAllRounder(battingAvg, economy);

  return {name, strikeRate, economy, battingAvg, isAllRounder: isHeAllRounder};
};
